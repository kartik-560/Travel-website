...
function TravelItineraryDetail() {
  ...
  // Decode the title for display and SEO
  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="keywords"
          content={`Himachal Pradesh, Shimla, Jiunthi Village, Delhi to Shimla trip, weekend getaway, Himalayan treks, Shimla itinerary, camping trips, hiking, nature tours`}
        />
        ...
        <meta
          ...
          content={`Join us for an unforgettable trip to ${decodedTitle}, featuring scenic hikes, peaceful camping under the stars, and immersive nature experiences. Perfect for nature lovers and adventure seekers.`}
        />
        <meta
          property="og:url"
          content={`https://yourwebsite.com/itinerary/${id}/${title}`}
        />
        <meta property="og:type" content="website" />
      </Helmet>

      <Header1 />
      <GallerySections tripId={id} />
      <Destinations />
    </>
  );
}
