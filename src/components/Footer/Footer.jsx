        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-8 mb-[-1rem] md:mb-[-5rem]">
          ...
          <div className="flex flex-col items-center md:items-start space-y-6 gap-1 mt-[-4.2rem]">
            ...
            <motion.a
              ...
              className="text-4xl font-bold cursor-pointer text-center md:text-left h-[32%] w-[33%] md:h-[35%] md:w-[38%] flex items-center justify-center mt-8 block"
              href="/"
            >
              <img
                src="/assest/logo.webp"
                alt="logo"
                className='h-[160%] mt-[0.9rem] w-full'
              />
            </motion.a>
